...
class PackageExtractorCore
{
     ...
     */
    public function __construct($targetDirectory = _PS_MODULE_DIR_)
    {
    ...
    protected function extractLocalPackage($filepath, $name)
    {
        ...
        try {
            return (
                $this->validatePackageContent($dir) &&
     ...
     * @return bool
     */
    protected function validatePackageContent($dir)
    {
        ...
        if ($this->packageValidator) {
            $errors = call_user_func($this->packageValidator, $files);
     ...
     * @return bool
     */
    protected function shouldCopyFile($file)
    {
        // check file name
